...
<motion.div
  className='flex-auto w-full md:w-1/3 lg:w-1/4 xl:w-1/5 2xl:w-1/6 h-64 rounded-xl p-6 shadow-lg mb-8  mx-8 flex flex-col justify-between transition-transform duration-300'
  style={{
  ...
  whileHover={{ y: ["0%", "-15%", "0%"], transition: { repeat: Infinity, duration: 0.5 } }} // Increase float effect and make it faster
>
